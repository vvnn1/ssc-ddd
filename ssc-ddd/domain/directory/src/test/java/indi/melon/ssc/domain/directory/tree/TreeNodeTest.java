...
class TreeNodeTest {
    ...
    @Test
    public void should_be_sorted_with_order() {
        TreeNode rootNode = buildNode(new NodeID("0"), null);
    ...
    public void only_root_node_can_invoke_add() {
        ...
        TreeNode childNode2 = buildNode(new NodeID("2"), new NodeID("1"));
        assertThrows(TreeNodeNotSupportException.class, () -> childNode1.add(childNode2));
    }
    ...
    public void can_be_parent_node_when_it_is_expandable(){
        ...
        assertThrows(TreeNodeNotSupportException.class, () -> rootNode.add(childNode4));
    }
