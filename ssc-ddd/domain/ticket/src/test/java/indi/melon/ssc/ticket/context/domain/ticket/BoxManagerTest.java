...
import indi.melon.ssc.context.ticket.domain.ticket.*;
import indi.melon.ssc.ticket.context.south.repository.TicketBoxRepository;
import indi.melon.ssc.ticket.context.thread.ParallelThread;
...
class BoxManagerTest {
    ...
    public void should_get_right_box_then_cache_some_box_and_update_currentMaxTicket() {
        ...
        AutoIncrTicketBox dbBox = (AutoIncrTicketBox) repository.get(boxID);
    ...
    public void should_release_right_box_then_re_full_cache_and_update_currentMaxTicket(){
        ...
        AutoIncrTicketBox dbBox2 = (AutoIncrTicketBox) repository.get(boxID);
        assertEquals(dbBox2.getCurrentMaxTicket(), currentMaxTicket + (cacheSize + 1) * ticketNum);
    }

    @Test
    public void multi_thread_should_get_same_box() throws InterruptedException {
    ...
    @Test
    public void get_and_released_box_should_be_thread_safe() throws InterruptedException {
    ...
    @Test
    public void after_create_box_can_get_box(){
    ...
    static class ExceptionTicketBoxRepositoryImpl implements TicketBoxRepository{
        ...
        @Override
        public void create(TicketBox<?> ticketBox) {
        }

        @Override
        public boolean update(TicketBox<?> ticketBox) {
            return false;
        }
    }
