...
import indi.melon.ssc.draft.context.domain.configuration.event.AttachmentAllocated;
import indi.melon.ssc.draft.context.domain.configuration.event.AttachmentDeallocated;
import indi.melon.ssc.draft.context.domain.configuration.event.EngineAllocated;
import indi.melon.ssc.draft.context.domain.configuration.event.EngineDeallocated;
